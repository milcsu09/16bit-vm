...
main (void)
{
  ...
  byte program[] = {
    VM_OPERATION_MOV_R_I, VM_REGISTER_R5, LITERAL (0x1234),
    VM_OPERATION_MOV_R_I, VM_REGISTER_R6, LITERAL (0xABCD),

    VM_OPERATION_PUSH_R, VM_REGISTER_R5,
    VM_OPERATION_MOV_R_R, VM_REGISTER_R5, VM_REGISTER_R6,
    VM_OPERATION_POP, VM_REGISTER_R6,
